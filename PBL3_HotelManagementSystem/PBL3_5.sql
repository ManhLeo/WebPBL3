...
insert into Account(IDAccount, UserName, Pass, PhanQuyen) Values ('KH01', 'KhachHang01', '1', 'Khách Hàng')
insert into Account(IDAccount, UserName, Pass, PhanQuyen) Values ('KH02', 'KhachHang02', '1', 'Khách Hàng')
insert into Account(IDAccount, UserName, Pass, PhanQuyen) Values ('KH03', 'KhachHang03', '1', 'Khách Hàng')
insert into Account(IDAccount, UserName, Pass, PhanQuyen) Values ('KH04', 'KhachHang04', '1', 'Khách Hàng')
insert into Account(IDAccount, UserName, Pass, PhanQuyen) Values ('KH05', 'KhachHang05', '1', 'Khách Hàng')
insert into Account(IDAccount, UserName, Pass, PhanQuyen) Values ('KH06', 'KhachHang06', '1', 'Khách Hàng')
Update Account
